  ...
  return (
    <View className="bg-black w-full h-full overflow-hidden">
          ...
          className="bg-[#DBDBDB] w-full h-full">
            ...
            <View className="w-full h-[26vh] shadow-[0_0_10px_rgba(0,0,0,0.3)] bg-[#EFEFEF] overflow-hidden relative rounded-b-xl">
              ...
              <View className="w-full h-full overflow-hidden absolute z-1 flex flex-col justify-between items-center py-[2vh] pt-[5vh]">
                ...
                <View className="w-[95%] flex flex-row justify-between items-center">
                    <Pressable className="bg-[#112D37] w-[40px] h-[40px] border-[1px] border-cyan-400 rounded-full flex justify-center items-center">
                ...
                <View className="w-[95%] flex flex-column justify-center items-end gap-1">
            ...
            <View className="w-full px-[2vw] flex flex-row justify-between items-center py-4">
