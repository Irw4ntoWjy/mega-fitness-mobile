...
export default function DetailedBuyPackages() {
  ...
  const CATEGORY_SECTIONS: Record<string, string[]> = {
    ...
    "Independant Athlete Pass": ["Gym Membership", "Recharge"],
  };
      ...
      >
        ...
        <View className="w-full h-[40%] bg-white flex justify-center px-3">
          <View className="flex flex-row justify-between items-center">
            <Text className="font-semibold text-[18px]">Campfire</Text>

            <Pressable
              onPress={() =>
                router.push({
                  pathname: "/packages/ProductDetails",
    ...
    <View className="bg-black w-full h-full">
      <ScrollView className="bg-[#EFEFEF] w-full h-full">
        <View className="pt-[5vh] rounded-t-xl pb-30 w-full">
          ...
          <Pressable onPress={() => router.back()} className="px-[5%]">
