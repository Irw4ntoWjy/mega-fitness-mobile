        ...
        >
            ...
            <InputBox>
              <View className="flex-row justify-between items-center">
                <TextInput
                  ...
                  className="text-lg text-gray-900 w-full"
                />
              </View>
            </InputBox>
          </View>
          ...
          <View className="mb-4">
            ...
            <Pressable onPress={() => setOpenDate(!openDate)}>
              <InputBox>
                <View className="flex-row justify-between items-center">
                  <Text className="text-lg text-gray-900 py-3 px-1">
            ...
            <InputBox>
              <View className="flex-row justify-between items-center">
                <TextInput
                  ...
                  className="text-lg text-gray-900 w-7/8"
                />
                <Text className="text-lg text-gray-400">kg</Text>
              </View>
            </InputBox>
          </View>
            ...
            <InputBox>
              <View className="flex-row justify-between items-center">
                <TextInput
                  ...
                  className="text-lg text-gray-900 w-7/8"
                />
                <Text className="text-lg text-gray-400">cm</Text>
              </View>
            </InputBox>
          </View>
        </ScrollView>
